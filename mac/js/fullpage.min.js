...
!function(e, t, n, o, r) {
  ...
  function $n(e, t, n) {
      var o;
      n = void 0 === n ? {} : n,
      "function" == typeof zt.CustomEvent ? o = new CustomEvent(t,{
          detail: n
  ...
  function(e, E) {
      ...
      if (!Ln(u, Ft)) {
          ...
          var x, i, c, f, a = !1, o = navigator.userAgent.match(/(iPhone|iPod|iPad|Android|playbook|silk|BlackBerry|BB10|Windows Phone|Tizen|Bada|webOS|IEMobile|Opera Mini)/), r = "ontouchstart"in zt || 0 < navigator.msMaxTouchPoints || navigator.maxTouchPoints, d = "string" == typeof e ? yn(e)[0] : e, A = xn(), s = An(), T = !1, t = !0, k = !0, v = [], p = {
              m: {
                  up: !0,
                  down: !0,
                  left: !0,
          ...
          var z, j, P, D = En({}, E), V = !1, W = !0, Y = ["parallax", "scrollOverflowReset", "dragAndMove", "offsetSections", "fadingEffect", "responsiveSlides", "continuousHorizontal", "interlockedSlides", "scrollHorizontally", "resetSliders", "cards", "dropEffect", "waterEffect"];
          Ct(),
          ...
          function() {
              if (!E.anchors.length) {
                  ...
                  t.length && t.length === yn(E.sectionSelector, d).length && (V = !0,
          ...
          function() {
              ...
              for (var e = yn(qt), t = 0; t < e.length; t++) {
                  ...
                  E.menu && E.css3 && null != Wn(yn(E.menu)[0], Dt) && yn(E.menu).forEach(function(e) {
                      L.appendChild(e)
                  }),
              ...
              E.navigation && function() {
                  ...
                  for (var o = "", r = 0; r < yn(qt).length; r++) {
                      ...
                      void 0 !== l && "" !== l && (o += '<div class="' + on + " fp-" + E.navigationPosition + '">' + l + "</div>"),
                      o += "</li>"
                  }
      ...
      function oe(e) {
          e ? (function() {
              var e, t = "";
              zt.addEventListener ? e = "addEventListener" : (e = "attachEvent",
              t = "on");
          ...
          d.addEventListener("mouseup", et)) : (jt.addEventListener ? (jt.removeEventListener("mousewheel", He, !1),
          jt.removeEventListener("wheel", He, !1),
          jt.removeEventListener("MozMousePixelScroll", He, !1)) : jt.detachEvent("onmousewheel", He),
      ...
      function he(e) {
          ...
          E.scrollOverflow && m.createScrollBarForAll()) : t && (Z(D.autoScrolling, "internal"),
      ...
      function ge(e) {
          ...
          .call(t, e) : Wn(t, E.menu + " [data-menuanchor]") && function(e) {
              !yn(E.menu)[0] || !E.lockAnchors && E.anchors.length || (Kn(e),
              ue(this.getAttribute("data-menuanchor")))
          }
          .call(t, e)
      }
      function me(e, t) {
          jt["fp_" + e] = t,
          jt.addEventListener(e, Se, !0)
      }
      function Se(e) {
          var t = e.type
            , o = !1
          ...
          ("mouseenter" !== t || W) && (E.normalScrollElements.split(",").forEach(function(e) {
              if (!o) {
                  var t = qn(i, e)
                    , n = Wn(i, e);
                  (t || n) && (g.shared.isNormalScrollElement || (ie(!1),
                  r && E.scrollOverflowHandler.setIscroll(i, !1)),
                  g.shared.isNormalScrollElement = !0,
                  o = !0)
              }
          }),
          !o && g.shared.isNormalScrollElement && (ie(!0),
      ...
      function be(e, t, n) {
          ...
          Yn(yn(cn, l)[0], a),
          "#fff" !== E.controlArrowColor && (Tn(yn(wn, l), {
      ...
      function Ee() {
          ...
          e = Qe(),
          t = mt(e.section),
          e.section && t && (void 0 === t || In(t) !== In(f)) || !_n(E.afterLoad) || Ne("afterLoad", {
              activeSection: n,
              element: n,
              direction: null,
      ...
      function Le() {
          ...
          if (!T && (!E.autoScrolling || E.scrollBar)) {
              ...
              n = yn(Qt)[0].offsetTop,
              o = n + xn(),
              ("up" != t ? n <= Un() : o >= Un() + xn()) && (Ln(yn(Qt)[0], _t) || (Nn(yn(Qt)[0], _t),
              zn(Xn(yn(Qt)[0]), _t))),
              !Ln(e = f[s], Xt)) {
                  F = !0;
                  var v, p, h = yn(Qt)[0], g = In(h, qt) + 1, m = vt(e), S = e.getAttribute("data-anchor"), w = In(e, qt) + 1, b = yn(an, e)[0], y = {
                      activeSection: h,
                      sectionIndex: w - 1,
                      anchorLink: S,
                      element: e,
      ...
      function ke(e) {
          ...
          if (Oe(e)) {
              ...
              _ = n.y,
              $ = n.x,
              yn(cn, t).length && Math.abs(K - $) > Math.abs(X - _) ? !a && Math.abs(K - $) > An() / 100 * E.touchSensitivity && ($ < K ? p.m.right && fe(t) : p.m.left && de(t)) : E.autoScrolling && k && Math.abs(X - _) > zt.innerHeight / 100 * E.touchSensitivity && (_ < X ? Ae("down") : X < _ && Ae("up"))
          }
      }
      function Oe(e) {
      ...
      function Re(e, t, n) {
          if (null != e) {
              ...
              if (!(d.activeSection == e && !T || E.scrollBar && Un() === d.dtop && !Ln(e, Zt))) {
                  ...
                  E.autoScrolling && E.continuousVertical && void 0 !== d.isMovementUp && (!d.isMovementUp && "up" == d.yMovement || d.isMovementUp && "down" == d.yMovement) && ((p = d).isMovementUp ? Fn(yn(Qt)[0], Zn(p.activeSection, qt)) : Yn(yn(Qt)[0], eo(p.activeSection, qt).reverse()),
      ...
      function Pe(e) {
          ...
          t.element = yn(Dt)[0]) : (t.options = e,
          t.element = zt),
          t
      }
      function De(e) {
          var t;
          null != (t = e).wrapAroundElements && (t.isMovementUp ? Fn(yn(qt)[0], t.wrapAroundElements) : Yn(yn(qt)[yn(qt).length - 1], t.wrapAroundElements),
          Tt(yn(Qt)[0].offsetTop),
          Be()),
      ...
      function Ge(e) {
          ...
          9 === n ? function(e) {
              ...
              l = je(Wn(i, ln)),
              a = ze(Wn(i, qt)),
              l || a) && (c ? null == Wn(c, Qt + "," + Qt + " " + an) && (c = f(e)) : f(e),
              (!s && c == u[u.length - 1] || s && c == u[0]) && Kn(e))
          }(e) : qn(t, "textarea") || qn(t, "input") || qn(t, "select") || "true" === t.getAttribute("contentEditable") || "" === t.getAttribute("contentEditable") || !E.keyboardScrolling || !E.autoScrolling || (-1 < [40, 38, 32, 33, 34].indexOf(n) && Kn(e),
          c = e.ctrlKey,
      ...
      function Ze(e) {
          2 == e.which && (G = e.pageY,
          d.addEventListener("mousemove", rt))
      }
      function et(e) {
      ...
      function rt(e) {
          E.autoScrolling && (k && (e.pageY < G && p.m.up ? ae() : e.pageY > G && p.m.down && se()),
          G = e.pageY)
      }
      function it(e, t, n) {
          var o, r, i = Wn(e, qt), l = {
          ...
          E.onSlideLeave && !l.localIsResizing && "none" !== l.xMovement && _n(E.onSlideLeave) && !1 === Ne("onSlideLeave", l) ? a = !1 : (Nn(t, Xt),
          zn(Xn(t), Xt),
          l.localIsResizing || (Ke(l.prevSlide),
          Ye(t)),
          !E.loopHorizontal && E.controlArrows && (Qn(yn(Sn, i), 0 !== l.slideIndex),
      ...
      function lt(e) {
          ...
          t = e.slidesNav,
          n = e.slideIndex,
          E.slidesNavigation && null != t && (zn(yn(Kt, t), Xt),
          Nn(yn("a", yn("li", t)[n]), Xt)),
          e.localIsResizing || (_n(E.afterSlideLoad) && Ne("afterSlideLoad", e),
          k = !0,
          Ue(e.destiny)),
          a = !1
      }
      ...
      function st() {
          ...
          o) {
              ...
              if (!qn(e, "textarea") && !qn(e, "input") && !qn(e, "select")) {
                  var t = xn();
                  Math.abs(t - J) > 20 * Math.max(J, t) / 100 && (ve(!0),
                  J = t)
              }
          } else
              we();
      ...
      function dt(e, t) {
          ...
          yn(E.menu).forEach(function(e) {
              E.menu && null != e && (zn(yn(Kt, e), Xt),
              Nn(yn('[data-menuanchor="' + n + '"]', e), Xt))
          }),
          o = e,
          r = t,
          E.navigation && null != yn(nn)[0] && (zn(yn(Kt, yn(nn)[0]), Xt),
      ...
      function St(e, t) {
          var n = mt(e);
          if (null != n) {
              var o, r, i, l = (null == (i = yn(ln + '[data-anchor="' + (o = t) + '"]', r = n)[0]) && (o = void 0 !== o ? o : 0,
              i = yn(ln, r)[o]),
              i);
      ...
      function xt(e) {
          ...
          r && Oe(e) && E.scrollBar && void 0 !== e.touches && (t.y = e.touches[0].pageY,
      ...
      function Ct() {
          ...
          console.warn("%c https://alvarotrigo.com/fullPage/", t)) : (bn("error", "Fullpage.js version 3 has changed its license to GPLv3 and it requires a `licenseKey` option. Read about it here:"),
          bn("error", "https://github.com/alvarotrigo/fullPage.js#options")),
          Ln(u, Ft) ? bn("error", "Fullpage.js can only be initialized once and you are doing it multiple times!") : (E.continuousVertical && (E.loopTop || E.loopBottom) && (E.continuousVertical = !1,
          bn("warn", "Option `loopTop/loopBottom` is mutually exclusive with `continuousVertical`; `continuousVertical` disabled")),
          !E.scrollOverflow || !E.scrollBar && E.autoScrolling || bn("warn", "Options scrollBar:true and autoScrolling:false are mutually exclusive with scrollOverflow:true. Sections with scrollOverflow might not work well in Firefox"),
          !E.continuousVertical || !E.scrollBar && E.autoScrolling || (E.continuousVertical = !1,
          bn("warn", "Scroll bars (`scrollBar:true` or `autoScrolling:false`) are mutually exclusive with `continuousVertical`; `continuousVertical` disabled")),
      ...
      function Ht(t, n, o, r) {
          var e, i = (e = t).self != zt && Ln(e, sn) ? e.scrollLeft : !E.autoScrolling || E.scrollBar ? Un() : e.offsetTop, l = n - i, a = 0;
          z = !0;
          var s = function() {
              if (z) {
                  var e = n;
